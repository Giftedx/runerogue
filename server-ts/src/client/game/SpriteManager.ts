...
export class SpriteManager {
  ...
  public drawSprite(
    ...
    const animation = spriteDefinition.animations.default || Object.values(spriteDefinition.animations)[0];
  ...
  public drawAnimatedSprite(
    ...
    if (spriteDefinition.directions && spriteDefinition.directions.includes(direction)) {
      ...
      animation = spriteDefinition.animations.default || Object.values(spriteDefinition.animations)[0];
    }
