...
const ASSET_CACHE_DIR = path.join(__dirname, '../assets/osrs-cache');
...
const COMBAT_ASSETS = [
  ...
  { name: 'Arrow.png', category: 'effects/projectiles', description: 'Basic arrow projectile' },
  {
    name: 'Bronze_arrow.png',
    category: 'effects/projectiles',
    description: 'Bronze arrow projectile',
  },
  { name: 'Iron_arrow.png', category: 'effects/projectiles', description: 'Iron arrow projectile' },
  {
    name: 'Magic_dart.png',
    category: 'effects/projectiles',
