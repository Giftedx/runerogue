...
// Removed duplicate Inventory component - using OSRS-style 28-slot version below
...
// Removed duplicate Item component - using OSRS-style version below
...
// ============================================
// Phase 4 Skill System Components
// ============================================

/**
 * ActiveEffects Component - Tracks temporary stat boosts and effects
 */
export const ActiveEffects = defineComponent({
  // Stat boost effects (each stores remaining duration in ms)
  attackBoost: Types.ui16,
  attackBoostAmount: Types.i8,
  strengthBoost: Types.ui16,
  strengthBoostAmount: Types.i8,
  defenceBoost: Types.ui16,
  defenceBoostAmount: Types.i8,
  rangedBoost: Types.ui16,
  rangedBoostAmount: Types.i8,
  magicBoost: Types.ui16,
  magicBoostAmount: Types.i8,

  // Status effects
  poisoned: Types.ui16,
  poisonDamage: Types.ui8,
  antifire: Types.ui16,
  energyRestore: Types.ui16,
...
/**
 * MagicCombat Component - Magic-specific combat data
 */
export const MagicCombat = defineComponent({
  selectedSpell: Types.ui16, // Spell ID
  autocast: Types.ui8, // 0 = manual, 1 = autocast
  lastCastTime: Types.ui32, // Last spell cast timestamp
  runePouch: Types.ui8, // Has rune pouch (affects rune storage)
});

/**
 * RangedCombat Component - Ranged-specific combat data
 */
export const RangedCombat = defineComponent({
  attackStyle: Types.ui8, // 0=accurate, 1=rapid, 2=longrange
  lastShotTime: Types.ui32, // Last shot timestamp
  ammunition: Types.ui16, // Equipped ammunition item ID
  ammunitionCount: Types.ui16, // Remaining ammunition
});

/**
 * SmithingAction Component - Tracks smithing activities
 */
export const SmithingAction = defineComponent({
  recipeId: Types.ui16,
...
/**
 * Item Component - Individual item data
 */
...
/**
 * LevelUpEvents Component - Tracks pending level-ups
 */
export const LevelUpEvents = defineComponent({
  pendingLevelUps: Types.ui32, // Bitmask of skills with pending level-ups
  lastCheck: Types.ui32,
});
