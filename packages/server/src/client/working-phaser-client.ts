...
/**
 * Minimal Working Phaser + Colyseus Client
 *
...
class GameScene extends Phaser.Scene {
  ...
  private setupRoomHandlers() {
    ...
    this.room.state.players.onChange((player: any, playerId: string) => {
    ...
    this.room.state.enemies.onChange((enemy: any, enemyId: string) => {
  ...
  private createPlayerSprite(playerId: string, player: any) {
  ...
  private updatePlayerSprite(playerId: string, player: any) {
  ...
  private createEnemySprite(enemyId: string, enemy: any) {
  ...
  private updateEnemySprite(enemyId: string, enemy: any) {
  ...
  private updateHealthBar(entityId: string, health: number, maxHealth: number) {
