...
exports.ROCKY_PET_DROP_RATE = exports.TINDERBOX_ID = exports.PHOENIX_PET_DROP_RATES = exports.PET_DROP_RATES = exports.FISH = exports.ROCK_GOLEM_PET_DROP_RATES = exports.BEAVER_PET_DROP_RATES = exports.BIRD_NEST_DROP_RATE = exports.FISHING_TOOLS = exports.MINING_TOOLS = exports.WOODCUTTING_TOOLS = exports.TOOL_EFFECTIVENESS = exports.LOGS = exports.COOKABLE_ITEMS = exports.FISHING_SPOTS = exports.ROCKS = exports.TREES = exports.SkillType = exports.ResourceType = void 0;
exports.calculateLevelFromXp = calculateLevelFromXp;
exports.calculateXpFromLevel = calculateXpFromLevel;
exports.getEffectiveTool = getEffectiveTool;
exports.calculateWoodcuttingSuccess = calculateWoodcuttingSuccess;
exports.calculateMiningSuccess = calculateMiningSuccess;
exports.calculateFishingSuccess = calculateFishingSuccess;
exports.calculateCookingSuccess = calculateCookingSuccess;
exports.calculateBurnChance = calculateBurnChance;
exports.calculateFiremakingSuccess = calculateFiremakingSuccess;
var ResourceType;
(function (ResourceType) {
    ResourceType[ResourceType["TREE"] = 1] = "TREE";
    ResourceType[ResourceType["ROCK"] = 2] = "ROCK";
    ResourceType[ResourceType["FISHING_SPOT"] = 3] = "FISHING_SPOT";
    ResourceType[ResourceType["COOKING_SPOT"] = 4] = "COOKING_SPOT";
})(ResourceType || (exports.ResourceType = ResourceType = {}));
var SkillType;
(function (SkillType) {
    SkillType[SkillType["WOODCUTTING"] = 1] = "WOODCUTTING";
    SkillType[SkillType["MINING"] = 2] = "MINING";
    SkillType[SkillType["FISHING"] = 3] = "FISHING";
    SkillType[SkillType["COOKING"] = 4] = "COOKING";
    SkillType[SkillType["FIREMAKING"] = 5] = "FIREMAKING";
...
function calculateXpFromLevel(level) {
    ...
    if (level > 99)
        throw new Error("Level cannot exceed 99");
    if (level === 1)
        return 0;
    let totalXp = 0;
...
exports.BIRD_NEST_DROP_RATE = 1 / 256;
exports.BEAVER_PET_DROP_RATES = {
    [exports.TREES.NORMAL.id]: 72321,
    [exports.TREES.OAK.id]: 72321,
    [exports.TREES.WILLOW.id]: 72321,
    [exports.TREES.TEAK.id]: 72321,
    [exports.TREES.MAPLE.id]: 72321,
    default: 72321,
};
exports.ROCK_GOLEM_PET_DROP_RATES = {
    [exports.ROCKS.COPPER.id]: 244640,
    [exports.ROCKS.TIN.id]: 244640,
    [exports.ROCKS.IRON.id]: 244640,
    [exports.ROCKS.SILVER.id]: 244640,
    [exports.ROCKS.COAL.id]: 244640,
    [exports.ROCKS.GOLD.id]: 244640,
    default: 244640,
};
 ...
 */
function getEffectiveTool(tools, playerLevel, playerId) {
    // For now, return the most appropriate tool for the level
    // In full implementation, check player's inventory
    const availableTools = Object.values(tools).filter((tool) => tool.level <= playerLevel);
    ...
    if (playerLevel >= 51) {
        ...
        // Prefer Rune tools
        return (availableTools.find((tool) => tool.name.includes("Rune")) ??
        ...
        return (availableTools.find((tool) => tool.name.includes("Adamant")) ??
            availableTools.find((tool) => tool.name.includes("Mithril")) ??
            availableTools.find((tool) => tool.name.includes("Steel")) ??
            availableTools.find((tool) => tool.name.includes("Bronze")) ??
            availableTools[0]);
        ...
        return (availableTools.find((tool) => tool.name.includes("Mithril")) ??
            availableTools.find((tool) => tool.name.includes("Steel")) ??
            availableTools.find((tool) => tool.name.includes("Bronze")) ??
            availableTools[0]);
    }
        ...
        // Prefer Steel tools
        return (availableTools.find((tool) => tool.name.includes("Steel")) ??
            availableTools.find((tool) => tool.name.includes("Bronze")) ??
            availableTools[0]);
    }
    else {
        ...
        const bronzeFound = availableTools.find((tool) => tool.name.includes("Bronze"));
        console.log(`Debug: Bronze found:`, bronzeFound?.name);
        return (availableTools.find((tool) => tool.name.includes("Bronze")) ??
            availableTools[0]); // fallback to any available tool
    }
}
/**
 ...
 */
function calculateWoodcuttingSuccess(playerLevel, treeLevel, toolEffectiveness) {
 ...
 * @returns Success chance (0.0-1.0)
 */
function calculateMiningSuccess(playerLevel, rockLevel, toolEffectiveness) {
 ...
 * @returns Success chance (0.0-1.0)
 */
function calculateFishingSuccess(playerLevel, fishLevel) {
 ...
 */
function calculateCookingSuccess(cookingLevel, foodLevel, toolEffectiveness = 1.0) {
 ...
 */
function calculateBurnChance(cookingLevel, foodLevel, burnStopLevel, isRange = false, hasCookingGauntlets = false) {
    // No burning after burn stop level
    if (cookingLevel >= burnStopLevel)
        return 0;
 ...
 */
function calculateFiremakingSuccess(firemakingLevel, logLevel, toolEffectiveness = 1.0) {
...
// Pet drop rates
exports.PET_DROP_RATES = {
    BEAVER: exports.BEAVER_PET_DROP_RATES,
    ROCK_GOLEM: exports.ROCK_GOLEM_PET_DROP_RATES,
    HERON: 257211, // Fishing pet
    ROCKY: 149389, // Thieving pet
    PHOENIX: 5000, // Firemaking pet
};
// Specific pet drop rates for firemaking
exports.PHOENIX_PET_DROP_RATES = {
    [exports.LOGS.NORMAL.id]: 5000,
    [exports.LOGS.OAK.id]: 5000,
    [exports.LOGS.WILLOW.id]: 5000,
    [exports.LOGS.TEAK.id]: 5000,
    [exports.LOGS.MAPLE.id]: 5000,
    default: 5000,
};
// Tinderbox item ID
exports.TINDERBOX_ID = 590;
// Rocky pet drop rate (thieving)
exports.ROCKY_PET_DROP_RATE = 149389;
/**
 * Calculate success chance for any gathering skill
 */
//# sourceMappingURL=gathering-data.js.map