// Quic    // Connect to the game server (using WSS for HTTPS server)
    const client = new Colyseus.Client('wss://localhost:2567');test to verify server connectivity and schema fix
